...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	...
	<div class="col-12">
            ...
            <div>
  			...
  			<div class="col-4">
			<a href="/series/list?pageNo=${pgvo.pageNo }&qty=${pgvo.qty}&genre=${pgvo.genre}" class="btn btn-primary">LIST</a>
			</div>
			<div class="col-4">
			<a href="/series/modify?mno=${mvo.mno }&pageNo=${pgvo.pageNo }&qty=${pgvo.qty}&genre=${pgvo.genre}" id="modBtn" class="btn btn-outline-warning">MOD</a>
			</div>
			<div class="col-4">
    		<button type="button" id="delBtn" class="btn btn-outline-danger">DEL</button>
			</div>
			
			<form action="/series/remove" method="post" id="delForm">
			...
			<script src="/resources/js/series.detail.js"></script>
