...
public class SeriesController {
	...
	public void modify(Model model, @RequestParam("sno")long sno) {
		model.addAttribute("svo",ssv.getDetailS(sno));
	}
	...
	public String remove(RedirectAttributes reAttr, @RequestParam("sno")long sno,
			@RequestParam("mno")long mno) {
		reAttr.addAttribute("isDel", ssv.removeS(sno)>0? "1":"0");
