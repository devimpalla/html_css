...
<form action="/movies/modify" method="post" enctype="multipart/form-data">
<input type="hidden" name="mno" value="${mvo.mno }">
	...
	<div class="col-12">
            ...
            <div class="col-12 d-grid">
  				...
  				<button type="button" id="trigger" class="btn btn-outline-primary btn-block d-block">새로운파일</button>
			</div>
